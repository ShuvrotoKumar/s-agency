          ...
          {pricingPlans.map((plan, index) => (
            ...
            >
              ...
              <CardHeader className="text-center pb-8 pt-8">
                ...
                <div className="mb-4">
                  <span className="text-5xl font-bold bg-gradient-primary bg-clip-text text-black">
                    {plan.price}
                  </span>
              ...
              <CardFooter>
                <Button
                  ...
                  size="lg"
                  className="w-full px-4 py-2 mt-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition"
                >
                  Get Started
                </Button>
              </CardFooter>
